        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                ...
                },
                {
                  ...
                  deadline: "31 July",
                  fee: "R100 (via CAO)",
                  url: "https://www.su.ac.za/en/apply/undergrad",
                  color: "amber",
                ...
                },
                {
                  ...
                  deadline: "30 September",
                  fee: "R100",
                  url: "https://www.ru.ac.za/admissiongateway/application/",
                  color: "indigo",
                ...
                },
                {
                  ...
                  deadline: "30 September",
                  fee: "R150",
                  url: "https://www.ul.ac.za/admissions/",
                  color: "violet",
          ...
          <div className="bg-card border border-border rounded-xl p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              {[
                { name: "DHET TVET Portal", desc: "Central portal to find your nearest TVET college", url: "https://www.dhet.gov.za/SitePages/TVETColleges.aspx" },
