...
export function JourneyHeader() {
  return <header className="journey-header"><Link href="/" className="journey-brand"><Compass size={26} aria-hidden="true" />Career<span>Intel</span><small>SA</small></Link><nav aria-label="Main navigation"><Link href="/start">Start here</Link><Link href="/explore">Explore careers</Link><Link href="/dashboard">My next steps</Link></nav><Link href="/sign-in" className="journey-button secondary">Sign in</Link></header>;
}
