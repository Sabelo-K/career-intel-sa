...
import {
  ...
  User, Settings, Zap, ChevronRight, Crown, Menu, X, Coins, Bell, GraduationCap, HeadphonesIcon, Briefcase, Users, Sparkles, Award, Gift,
} from "lucide-react";
...
const NAV_ITEMS: { href: string; icon: React.ElementType; key: TranslationKey }[] = [
  ...
  { href: "/graduate-programmes", icon: Award,           key: "graduateProgrammes"  },
  { href: "/bursaries",           icon: Gift,            key: "bursaries"           },
